...
public class CRFHistoryLocalServiceImpl extends CRFHistoryLocalServiceBaseImpl {
	...
	public List<CRFHistory> getCRFHistoryByG_C_S(long groupId, long crfId, long subjectId) {
		return super.crfHistoryPersistence.findByG_C_S(groupId, crfId, subjectId);
	}
	public List<CRFHistory> getCRFHistoryByG_C_S(long groupId, long crfId, long subjectId, int start, int end) {
		return super.crfHistoryPersistence.findByG_C_S(groupId, crfId, subjectId, start, end);
	}
	public List<CRFHistory> getCRFHistoryByG_C_S(long groupId, long crfId, long subjectId, int start, int end, OrderByComparator<CRFHistory> comparator) {
		return super.crfHistoryPersistence.findByG_C_S(groupId, crfId, subjectId, start, end, comparator);
	}
	public int countCRFHistoryByG_C_S(long groupId, long crfId, long subjectId) {
		return super.crfHistoryPersistence.countByG_C_S(groupId, crfId, subjectId);
	}
	
	public List<CRFHistory> getCRFHistoryByG_C_S_SD(long groupId, long crfId, long subjectId, long structuredDataId) {
		return super.crfHistoryPersistence.findByG_C_S_SD(groupId, crfId, subjectId, structuredDataId);
	}
	public List<CRFHistory> getCRFHistoryByG_C_S_SD(long groupId, long crfId, long subjectId, long structuredDataId, int start, int end) {
		return super.crfHistoryPersistence.findByG_C_S_SD(groupId, crfId, subjectId, structuredDataId, start, end);
	}
	public List<CRFHistory> getCRFHistoryByG_C_S_SD(long groupId, long crfId, long subjectId, long structuredDataId, int start, int end, OrderByComparator<CRFHistory> comparator) {
		return super.crfHistoryPersistence.findByG_C_S_SD(groupId, crfId, subjectId, structuredDataId, start, end, comparator);
	}
	public int countCRFHistoryByG_C_S_SD(long groupId, long crfId, long subjectId, long structuredDataId) {
		return super.crfHistoryPersistence.countByG_C_S_SD(groupId, crfId, subjectId, structuredDataId);
	}
