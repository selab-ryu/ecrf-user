...
/**
 * Provides the base implementation for the crf subject remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link ecrf.user.service.impl.CRFSubjectServiceImpl}.
 * </p>
 *
 * @author Ryu W.C.
 * @see ecrf.user.service.impl.CRFSubjectServiceImpl
 * @generated
 */
public abstract class CRFSubjectServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, CRFSubjectService, IdentifiableOSGiService {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CRFSubjectService.class, IdentifiableOSGiService.class
		};
	}
	...
	public String getOSGiServiceIdentifier() {
		return CRFSubjectService.class.getName();
	}
	...
	@Reference
	protected ecrf.user.service.CRFSubjectLocalService crfSubjectLocalService;

	protected CRFSubjectService crfSubjectService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CRFSubjectServiceBaseImpl.class);
