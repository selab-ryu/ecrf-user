...
import ecrf.user.service.LinkCRFService;
...
/**
 * Provides the base implementation for the link crf remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link ecrf.user.service.impl.LinkCRFServiceImpl}.
 * </p>
 *
 * @author Ryu W.C.
 * @see ecrf.user.service.impl.LinkCRFServiceImpl
 * @generated
 */
public abstract class LinkCRFServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, LinkCRFService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>LinkCRFService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>LinkCRFServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			LinkCRFService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		linkCRFService = (LinkCRFService)aopProxy;

		_setServiceUtilService(linkCRFService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return LinkCRFService.class.getName();
	}
	...
	private void _setServiceUtilService(LinkCRFService linkCRFService) {
		try {
			Field field = LinkCRFServiceUtil.class.getDeclaredField("_service");

			field.setAccessible(true);

			field.set(null, linkCRFService);
		}
	...
	@Reference
	protected ecrf.user.service.LinkCRFLocalService linkCRFLocalService;

	protected LinkCRFService linkCRFService;
