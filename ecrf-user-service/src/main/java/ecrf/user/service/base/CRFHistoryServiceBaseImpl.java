...
/**
 * Provides the base implementation for the crf history remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link ecrf.user.service.impl.CRFHistoryServiceImpl}.
 * </p>
 *
 * @author Ryu W.C.
 * @see ecrf.user.service.impl.CRFHistoryServiceImpl
 * @generated
 */
public abstract class CRFHistoryServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, CRFHistoryService, IdentifiableOSGiService {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CRFHistoryService.class, IdentifiableOSGiService.class
		};
	}
	...
	public String getOSGiServiceIdentifier() {
		return CRFHistoryService.class.getName();
	}
	...
	@Reference
	protected ecrf.user.service.CRFHistoryLocalService crfHistoryLocalService;

	protected CRFHistoryService crfHistoryService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CRFHistoryServiceBaseImpl.class);
