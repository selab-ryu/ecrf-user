 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link ecrf.user.service.impl.PatientLocalServiceImpl}.
 * </p>
 *
 * @author Ryu W.C.
 * @see ecrf.user.service.impl.PatientLocalServiceImpl
 * @generated
 */
public abstract class PatientLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PatientLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>PatientLocalServiceUtil</code>.
	 */
	...
	public Patient fetchPatientByUuidAndGroupId(String uuid, long groupId) {
		return patientPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<Patient>() {
	...
	public BasePersistence<Patient> getBasePersistence() {
	...
	public List<Patient> getPatientsByUuidAndCompanyId(
		...
		return patientPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<Patient> getPatientsByUuidAndCompanyId(
		...
		return patientPersistence.findByUuid_C(
	...
	public Patient getPatientByUuidAndGroupId(String uuid, long groupId)
		...
		return patientPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public void setAopProxy(Object aopProxy) {
		...
		_setLocalServiceUtilService(patientLocalService);
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = PatientLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, patientLocalService);
		}
