...
import ecrf.user.service.CRFSearchLogService;
import ecrf.user.service.CRFSearchLogServiceUtil;
...
/**
 * Provides the base implementation for the crf search log remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link ecrf.user.service.impl.CRFSearchLogServiceImpl}.
 * </p>
 *
 * @author Ryu W.C.
 * @see ecrf.user.service.impl.CRFSearchLogServiceImpl
 * @generated
 */
public abstract class CRFSearchLogServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, CRFSearchLogService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CRFSearchLogService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>CRFSearchLogServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CRFSearchLogService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		crfSearchLogService = (CRFSearchLogService)aopProxy;

		_setServiceUtilService(crfSearchLogService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return CRFSearchLogService.class.getName();
	}
	...
	private void _setServiceUtilService(
		CRFSearchLogService crfSearchLogService) {

		try {
			Field field = CRFSearchLogServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, crfSearchLogService);
		}
	...
	@Reference
	protected ecrf.user.service.CRFSearchLogLocalService
		crfSearchLogLocalService;

	protected CRFSearchLogService crfSearchLogService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CRFSearchLogServiceBaseImpl.class);
