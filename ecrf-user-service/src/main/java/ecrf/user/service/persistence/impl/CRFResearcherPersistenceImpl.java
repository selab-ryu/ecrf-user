...
import ecrf.user.service.persistence.CRFResearcherUtil;
...
public class CRFResearcherPersistenceImpl
	 ...
	 */
	@Override
	public List<CRFResearcher> filterFindByGroupId(long groupId) {
	 ...
	 */
	@Override
	public List<CRFResearcher> filterFindByGroupId(
		long groupId, int start, int end) {
	...
	public List<CRFResearcher> filterFindByGroupId(
		...
		if (getDB().isSupportsInlineDistinct()) {
			sb.append(_FILTER_SQL_SELECT_CRFRESEARCHER_WHERE);
		}
		else {
			sb.append(
				_FILTER_SQL_SELECT_CRFRESEARCHER_NO_INLINE_DISTINCT_WHERE_1);
		}
		...
		if (!getDB().isSupportsInlineDistinct()) {
			sb.append(
				_FILTER_SQL_SELECT_CRFRESEARCHER_NO_INLINE_DISTINCT_WHERE_2);
		}
		...
		if (orderByComparator != null) {
			...
			if (getDB().isSupportsInlineDistinct()) {
				...
				sb.append(CRFResearcherModelImpl.ORDER_BY_SQL);
			}
		}

		String sql = InlineSQLHelperUtil.replacePermissionCheck(
			sb.toString(), CRFResearcher.class.getName(),
		...
		try {
			...
			if (getDB().isSupportsInlineDistinct()) {
				sqlQuery.addEntity(
					_FILTER_ENTITY_ALIAS, CRFResearcherImpl.class);
			}
			else {
				sqlQuery.addEntity(
					_FILTER_ENTITY_TABLE, CRFResearcherImpl.class);
			}
			...
			return (List<CRFResearcher>)QueryUtil.list(
	...
	protected CRFResearcher filterGetByGroupId_PrevAndNext(
		Session session, CRFResearcher crfResearcher, long groupId,
		OrderByComparator<CRFResearcher> orderByComparator, boolean previous) {
		...
		if (getDB().isSupportsInlineDistinct()) {
			sqlQuery.addEntity(_FILTER_ENTITY_ALIAS, CRFResearcherImpl.class);
		}
		else {
			sqlQuery.addEntity(_FILTER_ENTITY_TABLE, CRFResearcherImpl.class);
		}
		...
		List<CRFResearcher> list = sqlQuery.list();
	...
	public int filterCountByGroupId(long groupId) {
		...
		sb.append(_FILTER_SQL_COUNT_CRFRESEARCHER_WHERE);
	 ...
	 */
	@Override
	public List<CRFResearcher> filterFindByG_C(long groupId, long crfId) {
	 ...
	 */
	@Override
	public List<CRFResearcher> filterFindByG_C(
		long groupId, long crfId, int start, int end) {
	...
	protected CRFResearcher filterGetByG_C_PrevAndNext(
		Session session, CRFResearcher crfResearcher, long groupId, long crfId,
		OrderByComparator<CRFResearcher> orderByComparator, boolean previous) {
	 ...
	 */
	@Override
	public List<CRFResearcher> filterFindByG_R(
		long groupId, long researcherId) {
	...
	public List<CRFResearcher> filterFindByG_R(
		...
		return filterFindByG_R(groupId, researcherId, start, end, null);
	}
	...
	protected CRFResearcher filterGetByG_R_PrevAndNext(
		Session session, CRFResearcher crfResearcher, long groupId,
		long researcherId, OrderByComparator<CRFResearcher> orderByComparator,
		boolean previous) {
	...
	public int filterCountByG_R(long groupId, long researcherId) {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return countByG_R(groupId, researcherId);
		}
	...
	public void cacheResult(List<CRFResearcher> crfResearchers) {
		if ((_valueObjectFinderCacheListThreshold == 0) ||
			((_valueObjectFinderCacheListThreshold > 0) &&
			 (crfResearchers.size() > _valueObjectFinderCacheListThreshold))) {
	...
	public CRFResearcher updateImpl(CRFResearcher crfResearcher) {
		...
		if (isNew && (crfResearcher.getCreateDate() == null)) {
			if (serviceContext == null) {
				crfResearcher.setCreateDate(date);
			}
			else {
				crfResearcher.setCreateDate(serviceContext.getCreateDate(date));
			}
		}

		if (!crfResearcherModelImpl.hasSetModifiedDate()) {
			if (serviceContext == null) {
				crfResearcher.setModifiedDate(date);
			}
			else {
	...
	public void deactivate() {
		_setCRFResearcherUtilPersistence(null);
	...
	private void _setCRFResearcherUtilPersistence(
		CRFResearcherPersistence crfResearcherPersistence) {

		try {
			Field field = CRFResearcherUtil.class.getDeclaredField(
				"_persistence");

			field.setAccessible(true);

			field.set(null, crfResearcherPersistence);
		}
	...
	private static final String _FILTER_ENTITY_TABLE_FILTER_PK_COLUMN =
		"crfResearcher.crfResearcherId";

	private static final String _FILTER_SQL_SELECT_CRFRESEARCHER_WHERE =
		"SELECT DISTINCT {crfResearcher.*} FROM EC_CRFResearcher crfResearcher WHERE ";

	private static final String
		_FILTER_SQL_SELECT_CRFRESEARCHER_NO_INLINE_DISTINCT_WHERE_1 =
			"SELECT {EC_CRFResearcher.*} FROM (SELECT DISTINCT crfResearcher.crfResearcherId FROM EC_CRFResearcher crfResearcher WHERE ";

	private static final String
		_FILTER_SQL_SELECT_CRFRESEARCHER_NO_INLINE_DISTINCT_WHERE_2 =
			") TEMP_TABLE INNER JOIN EC_CRFResearcher ON TEMP_TABLE.crfResearcherId = EC_CRFResearcher.crfResearcherId";

	private static final String _FILTER_SQL_COUNT_CRFRESEARCHER_WHERE =
		"SELECT COUNT(DISTINCT crfResearcher.crfResearcherId) AS COUNT_VALUE FROM EC_CRFResearcher crfResearcher WHERE ";

	private static final String _FILTER_ENTITY_ALIAS = "crfResearcher";

	private static final String _FILTER_ENTITY_TABLE = "EC_CRFResearcher";

	private static final String _ORDER_BY_ENTITY_ALIAS = "crfResearcher.";

	private static final String _ORDER_BY_ENTITY_TABLE = "EC_CRFResearcher.";
