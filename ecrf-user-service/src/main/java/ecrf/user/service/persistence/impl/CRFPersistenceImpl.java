...
public class CRFPersistenceImpl
	 ...
	 */
	@Override
	public List<CRF> findByG_M(long groupId, long managerId) {
		return findByG_M(
			groupId, managerId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	 ...
	 */
	@Override
	public List<CRF> findByG_M(
		long groupId, long managerId, int start, int end) {

		return findByG_M(groupId, managerId, start, end, null);
	}
	...
	public List<CRF> findByG_M(
		...
		return findByG_M(
			groupId, managerId, start, end, orderByComparator, true);
	}
	...
	public List<CRF> findByG_M(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				...
				finderArgs = new Object[] {groupId, managerId};
			}
		}
		else if (useFinderCache) {
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_G_M_MANAGERID_2);
	 ...
	 */
	@Override
	public CRF findByG_M_First(
			long groupId, long managerId,
			OrderByComparator<CRF> orderByComparator)
		throws NoSuchCRFException {

		CRF crf = fetchByG_M_First(groupId, managerId, orderByComparator);
	 ...
	 */
	@Override
	public CRF fetchByG_M_First(
		long groupId, long managerId,
		OrderByComparator<CRF> orderByComparator) {

		List<CRF> list = findByG_M(groupId, managerId, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public CRF findByG_M_Last(
			long groupId, long managerId,
			OrderByComparator<CRF> orderByComparator)
		throws NoSuchCRFException {

		CRF crf = fetchByG_M_Last(groupId, managerId, orderByComparator);
	 ...
	 */
	@Override
	public CRF fetchByG_M_Last(
		long groupId, long managerId,
		OrderByComparator<CRF> orderByComparator) {

		int count = countByG_M(groupId, managerId);

		if (count == 0) {
			return null;
		}

		List<CRF> list = findByG_M(
			groupId, managerId, count - 1, count, orderByComparator);
	 ...
	 */
	@Override
	public CRF[] findByG_M_PrevAndNext(
		...
		try {
			...
			array[0] = getByG_M_PrevAndNext(
				session, crf, groupId, managerId, orderByComparator, true);

			array[1] = crf;

			array[2] = getByG_M_PrevAndNext(
				session, crf, groupId, managerId, orderByComparator, false);
	...
	protected CRF getByG_M_PrevAndNext(
		Session session, CRF crf, long groupId, long managerId,
		OrderByComparator<CRF> orderByComparator, boolean previous) {
	 ...
	 */
	@Override
	public void removeByG_M(long groupId, long managerId) {
		for (CRF crf :
				findByG_M(
					groupId, managerId, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
					null)) {
	 ...
	 */
	@Override
	public int countByG_M(long groupId, long managerId) {
		FinderPath finderPath = _finderPathCountByG_M;

		Object[] finderArgs = new Object[] {groupId, managerId};
	...
	private static final String _FINDER_COLUMN_G_M_MANAGERID_2 =
		"crf.managerId = ?";
	...
	public CRF updateImpl(CRF crf) {
		...
		if (!_columnBitmaskEnabled) {
			...
			args = new Object[] {
				crfModelImpl.getGroupId(), crfModelImpl.getManagerId()
			};
			...
			if ((crfModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					crfModelImpl.getOriginalGroupId(),
					crfModelImpl.getOriginalManagerId()
				};
	...
	public void activate() {
		...
		_finderPathWithoutPaginationFindByG_M = new FinderPath(
			...
			CRFModelImpl.GROUPID_COLUMN_BITMASK |
			CRFModelImpl.MANAGERID_COLUMN_BITMASK |
			CRFModelImpl.CREATEDATE_COLUMN_BITMASK);
