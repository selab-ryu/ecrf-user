...
package ecrf.user.service.persistence.impl.constants;
 ...
 * @generated
 */
public class ECPersistenceConstants {

	public static final String BUNDLE_SYMBOLIC_NAME = "ecrf.user.service";
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(ECPersistenceConstants.class);
