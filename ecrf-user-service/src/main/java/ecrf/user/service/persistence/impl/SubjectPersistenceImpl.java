...
public class SubjectPersistenceImpl
	...
	private FinderPath _finderPathFetchBySubjectId;
	...
	public Subject findBySubjectId(long subjectId)
		...
		Subject subject = fetchBySubjectId(subjectId);
	...
	public Subject fetchBySubjectId(long subjectId, boolean useFinderCache) {
		...
		if (useFinderCache) {
			result = finderCache.getResult(
				_finderPathFetchBySubjectId, finderArgs, this);
		}
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					if (useFinderCache) {
						finderCache.putResult(
							_finderPathFetchBySubjectId, finderArgs, list);
					}
				}
				else {
					Subject subject = list.get(0);
				...
				if (useFinderCache) {
					finderCache.removeResult(
						_finderPathFetchBySubjectId, finderArgs);
				}
	...
	private FinderPath _finderPathFetchBySerialId;
	...
	public Subject fetchBySerialId(String serialId, boolean useFinderCache) {
		...
		if (useFinderCache) {
			result = finderCache.getResult(
				_finderPathFetchBySerialId, finderArgs, this);
		}
		...
		if (result == null) {
			...
			if (serialId.isEmpty()) {
				sb.append(_FINDER_COLUMN_SERIALID_SERIALID_3);
			}
			else {
				bindSerialId = true;

				sb.append(_FINDER_COLUMN_SERIALID_SERIALID_2);
			}
			...
			try {
				...
				if (list.isEmpty()) {
					if (useFinderCache) {
						finderCache.putResult(
							_finderPathFetchBySerialId, finderArgs, list);
					}
				}
				else {
					Subject subject = list.get(0);
				...
				if (useFinderCache) {
					finderCache.removeResult(
						_finderPathFetchBySerialId, finderArgs);
				}
	...
	private static final String _FINDER_COLUMN_SERIALID_SERIALID_3 =
		"(subject.serialId IS NULL OR subject.serialId = '')";

	private FinderPath _finderPathWithPaginationFindBySubjectName;
	private FinderPath _finderPathWithoutPaginationFindBySubjectName;
	private FinderPath _finderPathCountBySubjectName;
	 ...
	 */
	@Override
	public List<Subject> findBySubjectName(String name, int start, int end) {
		return findBySubjectName(name, start, end, null);
	}
	...
	public List<Subject> findBySubjectName(
		...
		return findBySubjectName(name, start, end, orderByComparator, true);
	}
	...
	public List<Subject> findBySubjectName(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath = _finderPathWithoutPaginationFindBySubjectName;
				finderArgs = new Object[] {name};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindBySubjectName;
		...
		if (list == null) {
			...
			if (name.isEmpty()) {
				sb.append(_FINDER_COLUMN_SUBJECTNAME_NAME_3);
			}
			else {
				bindName = true;

				sb.append(_FINDER_COLUMN_SUBJECTNAME_NAME_2);
			}
	...
	public Subject findBySubjectName_First(
		...
		Subject subject = fetchBySubjectName_First(name, orderByComparator);
	...
	public Subject fetchBySubjectName_First(
		...
		List<Subject> list = findBySubjectName(name, 0, 1, orderByComparator);
	...
	public Subject findBySubjectName_Last(
		...
		Subject subject = fetchBySubjectName_Last(name, orderByComparator);
	...
	public Subject fetchBySubjectName_Last(
		...
		int count = countBySubjectName(name);

		if (count == 0) {
			return null;
		}

		List<Subject> list = findBySubjectName(
	...
	public Subject[] findBySubjectName_PrevAndNext(
		...
		try {
			...
			array[0] = getBySubjectName_PrevAndNext(
				session, subject, name, orderByComparator, true);

			array[1] = subject;

			array[2] = getBySubjectName_PrevAndNext(
	...
	protected Subject getBySubjectName_PrevAndNext(
	...
	public int countBySubjectName(String name) {
		...
		FinderPath finderPath = _finderPathCountBySubjectName;
	...
	private static final String _FINDER_COLUMN_SUBJECTNAME_NAME_2 =
		"subject.name = ?";

	private static final String _FINDER_COLUMN_SUBJECTNAME_NAME_3 =
	 ...
	 */
	@Override
	public List<Subject> findByGroupId(long groupId) {
	 ...
	 */
	@Override
	public List<Subject> findByGroupId(long groupId, int start, int end) {
	 ...
	 */
	@Override
	public List<Subject> findByGroupId(
	...
	public Subject findByGroupId_First(
		...
		Subject subject = fetchByGroupId_First(groupId, orderByComparator);
	...
	public Subject fetchByGroupId_First(
		...
		List<Subject> list = findByGroupId(groupId, 0, 1, orderByComparator);
	...
	public Subject findByGroupId_Last(
		...
		Subject subject = fetchByGroupId_Last(groupId, orderByComparator);
	...
	public Subject fetchByGroupId_Last(
		...
		List<Subject> list = findByGroupId(
	...
	public Subject[] findByGroupId_PrevAndNext(
		...
		try {
			...
			array[0] = getByGroupId_PrevAndNext(
				session, subject, groupId, orderByComparator, true);

			array[1] = subject;

			array[2] = getByGroupId_PrevAndNext(
				session, subject, groupId, orderByComparator, false);
	...
	protected Subject getByGroupId_PrevAndNext(
		Session session, Subject subject, long groupId,
		OrderByComparator<Subject> orderByComparator, boolean previous) {
	...
	/**
	 * Returns all the subjects that the user has permission to view where groupId = &#63;.
	 *
	 * @param groupId the group ID
	 * @return the matching subjects that the user has permission to view
	 */
	@Override
	public List<Subject> filterFindByGroupId(long groupId) {
		return filterFindByGroupId(
			groupId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the subjects that the user has permission to view where groupId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>SubjectModelImpl</code>.
	 * </p>
	 ...
	 * @param start the lower bound of the range of subjects
	 * @param end the upper bound of the range of subjects (not inclusive)
	 * @return the range of matching subjects that the user has permission to view
	 */
	@Override
	public List<Subject> filterFindByGroupId(long groupId, int start, int end) {
		return filterFindByGroupId(groupId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the subjects that the user has permissions to view where groupId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>SubjectModelImpl</code>.
	 * </p>
	 ...
	 * @param end the upper bound of the range of subjects (not inclusive)
	 * @param orderByComparator the comparator to order the results by (optionally <code>null</code>)
	 * @return the ordered range of matching subjects that the user has permission to view
	 */
	@Override
	public List<Subject> filterFindByGroupId(
		long groupId, int start, int end,
		OrderByComparator<Subject> orderByComparator) {
		...
		if (getDB().isSupportsInlineDistinct()) {
			sb.append(_FILTER_SQL_SELECT_SUBJECT_WHERE);
		}
		else {
			sb.append(_FILTER_SQL_SELECT_SUBJECT_NO_INLINE_DISTINCT_WHERE_1);
		}

		sb.append(_FINDER_COLUMN_GROUPID_GROUPID_2);

		if (!getDB().isSupportsInlineDistinct()) {
			sb.append(_FILTER_SQL_SELECT_SUBJECT_NO_INLINE_DISTINCT_WHERE_2);
		}
		...
		if (orderByComparator != null) {
			...
			if (getDB().isSupportsInlineDistinct()) {
				...
				sb.append(SubjectModelImpl.ORDER_BY_SQL);
			}
		}

		String sql = InlineSQLHelperUtil.replacePermissionCheck(
			sb.toString(), Subject.class.getName(),
		...
		try {
			...
			if (getDB().isSupportsInlineDistinct()) {
				sqlQuery.addEntity(_FILTER_ENTITY_ALIAS, SubjectImpl.class);
			}
			else {
				sqlQuery.addEntity(_FILTER_ENTITY_TABLE, SubjectImpl.class);
			}
			...
			return (List<Subject>)QueryUtil.list(
	...
	/**
	 * Returns the subjects before and after the current subject in the ordered set of subjects that the user has permission to view where groupId = &#63;.
	 *
	 * @param subjectId the primary key of the current subject
	 * @param groupId the group ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public Subject[] filterFindByGroupId_PrevAndNext(
			long subjectId, long groupId,
			OrderByComparator<Subject> orderByComparator)
		throws NoSuchSubjectException {
	...
	protected Subject filterGetByGroupId_PrevAndNext(
		Session session, Subject subject, long groupId,
		OrderByComparator<Subject> orderByComparator, boolean previous) {
		...
		List<Subject> list = sqlQuery.list();
	...
	/**
	 * Returns the number of subjects that the user has permission to view where groupId = &#63;.
	 *
	 * @param groupId the group ID
	 * @return the number of matching subjects that the user has permission to view
	 */
	@Override
	public int filterCountByGroupId(long groupId) {
		...
		sb.append(_FILTER_SQL_COUNT_SUBJECT_WHERE);
	...
	public void cacheResult(Subject subject) {
		...
		finderCache.putResult(
			_finderPathFetchBySubjectId, new Object[] {subject.getSubjectId()},
			subject);
	...
	protected void cacheUniqueFindersCache(SubjectModelImpl subjectModelImpl) {
		...
		args = new Object[] {subjectModelImpl.getSubjectId()};

		finderCache.putResult(
			_finderPathCountBySubjectId, args, Long.valueOf(1), false);
		finderCache.putResult(
		...
		finderCache.putResult(
			_finderPathFetchBySerialId, args, subjectModelImpl, false);
	}
	...
	protected void clearUniqueFindersCache(
		...
		if (clearCurrent) {
			Object[] args = new Object[] {subjectModelImpl.getSubjectId()};

			finderCache.removeResult(_finderPathCountBySubjectId, args);
			finderCache.removeResult(_finderPathFetchBySubjectId, args);
		}

		if ((subjectModelImpl.getColumnBitmask() &
			 _finderPathFetchBySubjectId.getColumnBitmask()) != 0) {

			Object[] args = new Object[] {
				subjectModelImpl.getOriginalSubjectId()
			};
	...
	public Subject updateImpl(Subject subject) {
		...
		if (!_columnBitmaskEnabled) {
			...
			args = new Object[] {subjectModelImpl.getName()};

			finderCache.removeResult(_finderPathCountBySubjectName, args);
			finderCache.removeResult(
				_finderPathWithoutPaginationFindBySubjectName, args);

			args = new Object[] {subjectModelImpl.getGroupId()};
			...
			if ((subjectModelImpl.getColumnBitmask() &
				 _finderPathWithoutPaginationFindBySubjectName.
					 getColumnBitmask()) != 0) {

				Object[] args = new Object[] {
					subjectModelImpl.getOriginalName()
				};
	...
	public void activate() {
		...
		_finderPathWithoutPaginationFindByUuid = new FinderPath(
			...
			SubjectModelImpl.CREATEDATE_COLUMN_BITMASK);
		...
		_finderPathFetchBySubjectId = new FinderPath(
			entityCacheEnabled, finderCacheEnabled, SubjectImpl.class,
			FINDER_CLASS_NAME_ENTITY, "fetchBySubjectId",
			new String[] {Long.class.getName()},
			SubjectModelImpl.SUBJECTID_COLUMN_BITMASK);
		...
		_finderPathWithoutPaginationFindBySubjectName = new FinderPath(
			entityCacheEnabled, finderCacheEnabled, SubjectImpl.class,
		...
		_finderPathCountBySubjectName = new FinderPath(
			entityCacheEnabled, finderCacheEnabled, Long.class,
	...
	public void setConfiguration(Configuration configuration) {
		...
		_columnBitmaskEnabled = GetterUtil.getBoolean(
			configuration.get(
				"value.object.column.bitmask.enabled.ecrf.user.model.Subject"),
			true);
	}
	...
	private static final String _FILTER_SQL_SELECT_SUBJECT_WHERE =
		"SELECT DISTINCT {subject.*} FROM EC_Subject subject WHERE ";

	private static final String
		_FILTER_SQL_SELECT_SUBJECT_NO_INLINE_DISTINCT_WHERE_1 =
			"SELECT {EC_Subject.*} FROM (SELECT DISTINCT subject.subjectId FROM EC_Subject subject WHERE ";

	private static final String
		_FILTER_SQL_SELECT_SUBJECT_NO_INLINE_DISTINCT_WHERE_2 =
			") TEMP_TABLE INNER JOIN EC_Subject ON TEMP_TABLE.subjectId = EC_Subject.subjectId";

	private static final String _FILTER_SQL_COUNT_SUBJECT_WHERE =
		"SELECT COUNT(DISTINCT subject.subjectId) AS COUNT_VALUE FROM EC_Subject subject WHERE ";

	private static final String _FILTER_ENTITY_ALIAS = "subject";

	private static final String _FILTER_ENTITY_TABLE = "EC_Subject";

	private static final String _ORDER_BY_ENTITY_ALIAS = "subject.";

	private static final String _ORDER_BY_ENTITY_TABLE = "EC_Subject.";
