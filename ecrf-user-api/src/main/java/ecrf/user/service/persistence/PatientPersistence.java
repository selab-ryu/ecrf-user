...
public interface PatientPersistence extends BasePersistence<Patient> {
	 ...
	 */
	public java.util.List<Patient> findByUuid(String uuid);
	 ...
	 */
	public java.util.List<Patient> findByUuid(String uuid, int start, int end);
	 ...
	 */
	public java.util.List<Patient> findByUuid(
	 ...
	 * @return the matching patients
	 */
	public java.util.List<Patient> findByUuid_C(String uuid, long companyId);
	 ...
	 * @return the range of matching patients
	 */
	public java.util.List<Patient> findByUuid_C(
	 ...
	 * @return the matching patients
	 */
	public java.util.List<Patient> findByGroupId(long groupId);
	 ...
	 * @return the range of matching patients
	 */
	public java.util.List<Patient> findByGroupId(
