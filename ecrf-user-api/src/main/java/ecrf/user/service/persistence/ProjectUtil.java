...
public class ProjectUtil {
	...
	public static Project findByUuid_First(
		...
		throws ecrf.user.exception.NoSuchProjectException {
	 ...
	 */
	public static List<Project> filterFindByGroupId(long groupId) {
	 ...
	 */
	public static List<Project> filterFindByGroupId(
		long groupId, int start, int end) {
	 ...
	 * @throws NoSuchProjectException if a project with the primary key could not be found
	 */
	public static Project[] filterFindByGroupId_PrevAndNext(
			long projectId, long groupId,
			OrderByComparator<Project> orderByComparator)
		throws ecrf.user.exception.NoSuchProjectException {
