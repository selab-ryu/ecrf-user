...
public class ResearcherUtil {
	 ...
	 * @return the matching researchers
	 */
	public static List<Researcher> findByG_RU(
		long groupId, long researcherUserId) {

		return getPersistence().findByG_RU(groupId, researcherUserId);
	}
	...
	public static List<Researcher> findByG_RU(
		...
		return getPersistence().findByG_RU(
			groupId, researcherUserId, start, end);
	}
	 ...
	 * @throws NoSuchResearcherException if a matching researcher could not be found
	 */
	public static Researcher findByG_RU_First(
			long groupId, long researcherUserId,
			OrderByComparator<Researcher> orderByComparator)
		throws ecrf.user.exception.NoSuchResearcherException {

		return getPersistence().findByG_RU_First(
	 ...
	 * @return the first matching researcher, or <code>null</code> if a matching researcher could not be found
	 */
	public static Researcher fetchByG_RU_First(
		long groupId, long researcherUserId,
		OrderByComparator<Researcher> orderByComparator) {

		return getPersistence().fetchByG_RU_First(
			groupId, researcherUserId, orderByComparator);
	}
	 ...
	 * @throws NoSuchResearcherException if a matching researcher could not be found
	 */
	public static Researcher findByG_RU_Last(
			long groupId, long researcherUserId,
			OrderByComparator<Researcher> orderByComparator)
		throws ecrf.user.exception.NoSuchResearcherException {

		return getPersistence().findByG_RU_Last(
			groupId, researcherUserId, orderByComparator);
	}
	 ...
	 * @return the last matching researcher, or <code>null</code> if a matching researcher could not be found
	 */
	public static Researcher fetchByG_RU_Last(
		long groupId, long researcherUserId,
		OrderByComparator<Researcher> orderByComparator) {

		return getPersistence().fetchByG_RU_Last(
			groupId, researcherUserId, orderByComparator);
	}
	 ...
	 * @throws NoSuchResearcherException if a researcher with the primary key could not be found
	 */
	public static Researcher[] findByG_RU_PrevAndNext(
			long researcherId, long groupId, long researcherUserId,
			OrderByComparator<Researcher> orderByComparator)
		throws ecrf.user.exception.NoSuchResearcherException {

		return getPersistence().findByG_RU_PrevAndNext(
	 ...
	 * @return the matching researchers that the user has permission to view
	 */
	public static List<Researcher> filterFindByG_RU(
		long groupId, long researcherUserId) {

		return getPersistence().filterFindByG_RU(groupId, researcherUserId);
	}
	...
	public static List<Researcher> filterFindByG_RU(
		...
		return getPersistence().filterFindByG_RU(
			groupId, researcherUserId, start, end);
	}
	 ...
	 * @throws NoSuchResearcherException if a researcher with the primary key could not be found
	 */
	public static Researcher[] filterFindByG_RU_PrevAndNext(
			long researcherId, long groupId, long researcherUserId,
			OrderByComparator<Researcher> orderByComparator)
		throws ecrf.user.exception.NoSuchResearcherException {

		return getPersistence().filterFindByG_RU_PrevAndNext(
			researcherId, groupId, researcherUserId, orderByComparator);
	}
	 ...
	 * @param researcherUserId the researcher user ID
	 */
	public static void removeByG_RU(long groupId, long researcherUserId) {
		getPersistence().removeByG_RU(groupId, researcherUserId);
	}
	 ...
	 * @return the number of matching researchers
	 */
	public static int countByG_RU(long groupId, long researcherUserId) {
		return getPersistence().countByG_RU(groupId, researcherUserId);
	}
	 ...
	 * @return the number of matching researchers that the user has permission to view
	 */
	public static int filterCountByG_RU(long groupId, long researcherUserId) {
		return getPersistence().filterCountByG_RU(groupId, researcherUserId);
	}
