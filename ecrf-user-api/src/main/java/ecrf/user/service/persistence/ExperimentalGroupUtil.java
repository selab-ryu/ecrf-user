...
public class ExperimentalGroupUtil {
	 ...
	 */
	public static List<ExperimentalGroup> filterFindByGroupId(long groupId) {
	 ...
	 */
	public static List<ExperimentalGroup> filterFindByGroupId(
		long groupId, int start, int end) {
	 ...
	 * @throws NoSuchExperimentalGroupException if a experimental group with the primary key could not be found
	 */
	public static ExperimentalGroup[] filterFindByGroupId_PrevAndNext(
			long experimentalGroupId, long groupId,
			OrderByComparator<ExperimentalGroup> orderByComparator)
		throws ecrf.user.exception.NoSuchExperimentalGroupException {
	 ...
	 * @throws NoSuchExperimentalGroupException if a matching experimental group could not be found
	 */
	public static ExperimentalGroup findByG_N(long groupId, String name)
		throws ecrf.user.exception.NoSuchExperimentalGroupException {
	 ...
	 * @return the matching experimental group, or <code>null</code> if a matching experimental group could not be found
	 */
	public static ExperimentalGroup fetchByG_N(long groupId, String name) {
	 ...
	 * @return the matching experimental group, or <code>null</code> if a matching experimental group could not be found
	 */
	public static ExperimentalGroup fetchByG_N(
	 ...
	 * @return the experimental group that was removed
	 */
	public static ExperimentalGroup removeByG_N(long groupId, String name)
		throws ecrf.user.exception.NoSuchExperimentalGroupException {
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(
			ExperimentalGroupPersistence.class);

		ServiceTracker
			<ExperimentalGroupPersistence, ExperimentalGroupPersistence>
				serviceTracker =
					new ServiceTracker
						<ExperimentalGroupPersistence,
						 ExperimentalGroupPersistence>(
							 bundle.getBundleContext(),
							 ExperimentalGroupPersistence.class, null);
