...
/**
 * Provides the local service interface for CRFHistory. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Ryu W.C.
 * @see CRFHistoryLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CRFHistoryLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>ecrf.user.service.impl.CRFHistoryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the crf history local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CRFHistoryLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CRFHistory> getCRFHistoryByGroupId(
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CRFHistory> getCRFHistoryByHistoryId(
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CRFHistory> getCRFHistoryBySubjectId(
	...
	public CRFHistory updateCRFHistory(
			...
			long structuredDataId, long crfId, String previousJSON,
			String currentJSON, int actionType, String historyVersion,
			String previousVersion, ServiceContext sc)
		throws PortalException;
